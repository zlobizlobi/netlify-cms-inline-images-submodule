/*
This file is a copy of 'netlify-cms-backend-fs/dist/fs/fs-express-api.js'.
The only one thing is changed here (line 12), the site path is set up to the one level upper folder, where is our content located.
*/

const bodyParser = require('body-parser');
const multer = require('multer');
const fsAPI = require('netlify-cms-backend-fs/dist/fs/fs-api');
